...
import { CLASS_BASE } from '../../constants';
  ...
  export const DEFAULT_ICON_PATHS: Record<IconVariant, React.SVGProps<SVGPathElement>[]> = {
    google: [{
  ...
  const DEFAULT_ICON_ATTRIBUTES: Record<IconVariant, React.SVGProps<SVGSVGElement> & React.RefAttributes<SVGSVGElement>> = {
    google: {
...
export const oktaIcon : JSX.Element = 
  <svg className={`${CLASS_BASE}__icon amplify-icon federated-sign-in-icon`} width="100px" height="100px" viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
  <title>Avatar / Images / App Types / SPA</title>
  <desc>Created with Sketch.</desc>
  <g id="Avatar-/-Images-/-App-Types-/-SPA" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
      <rect fill="none" x="0" y="0" width="100" height="100"></rect>
      <g id="Group-2">
          <rect id="Rectangle" x="0" y="0" width="100" height="100"></rect>
      </g>
      <g id="spa" transform="translate(18.750000, 18.750000)" fillRule="nonzero">
